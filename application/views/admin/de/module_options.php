...
$aLang     = array(
   ...
   'SHOP_MODULE_blTinyMCE_filemanager'     => 'Filemanager aktivieren',
   'SHOP_MODULE_aTinyMCE_classes'          => '<h3>Liste der Backend-Klassen, wo TinyMCE geladen werden soll</h3><ul><li>article_main (Artikelbeschreibung)</li><li>content_main (CMS Seiten)</li><li>category_text (Kategorienbeschreibung)</li><li>newsletter_main (Newsletter)</li><li>news_text (Nachrichten-Text)</li></ul>',
   ...
   'SHOP_MODULE_aTinyMCE_externaljs'       => '<h3>externe JS Bibliotheken</h3> z.b. für bestimmte Plugins',
   'HELP_SHOP_MODULE_aTinyMCE_externaljs'  => 'es muss komplette URL angegeben werden. Falls der Shop über https:// läuft, sollten diese Bibliotheken ebenfalls über https:// geladen werden',

   'SHOP_MODULE_GROUP_tinyMceSettings'     => 'TinyMCE Einstellungen &amp; Plugins',
    
   'SHOP_MODULE_aTinyMCE_config'           => '<h3>Editor Konfiguration überschreiben <a href="http://www.tinymce.com/wiki.php/Configuration" target="_blank" title="mehr Infos">(?)</a></h3>z.B. Parameter für externe Plugins oder um standard Parameter zu überschreiben<br/><b>parameter => "wert"</b> (mit Anführungszeichen, falls erforderlich!)',
   'SHOP_MODULE_aTinyMCE_plugins'          => '<h3>Editor Plugins überschreiben <a href="http://www.tinymce.com/wiki.php/Plugins" target="_blank">(?)</a></h3>jeweils ein Plugin pro Zeile.<br/>Standardwerte finden Sie in dem Hilfe-Popup',
