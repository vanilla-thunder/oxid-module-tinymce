...
$aLang     = array(
    ...
    'SHOP_MODULE_aTinyMCE_externaljs'       => '<h3>external JS libraries</h3> e.g. plugin dependencies',
    'HELP_SHOP_MODULE_aTinyMCE_externaljs'  => 'if your shop uses https, external libraries should be loaded with https, too',
    ...
    'SHOP_MODULE_aTinyMCE_buttons'          => '<h3>Toolbar Buttons <a href="http://www.tinymce.com/wiki.php/Controls" target="_blank">(?)</a></h3><b style="color:#ff3600;">only for core toolbar controls and buttons for custom and external plugins!</b><br/>Buttons for standard plugins will be displayd if the plugin is active.<br/>See the help popup for the default value of this setting',
